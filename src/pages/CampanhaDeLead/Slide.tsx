          ...
          <motion.div variants={itemVariants} className="space-y-4">
            {slide.communityLink && (
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                ...
                >
                  <ExternalLink size={18} /> Acessar comunidade Extremo Plus
                </a>
        ...
        {slide.whatsappScript && (
          <motion.div variants={itemVariants}>
            <div className={`rounded-xl border ${theme.card} overflow-hidden ${theme.isDark ? "bg-white/10" : "bg-slate-800"}`}>
              ...
              <div className="p-4">
                <p className={`text-2xl sm:text-3xl leading-snug ${theme.isDark ? theme.body : "text-white/95"}`}>{slide.whatsappScript}</p>
              </div>
